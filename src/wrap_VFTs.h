/* $Id: wrap_VFTs.h,v 1.7 2004/07/07 14:52:39 bird Exp $
 *
...
#ifdef NPODIN
/** @group Visual C++ v6.0 target (Win32).
 * @{ */
/** Indicate Visual C++ v6.0 target */
#define VFT_VC60            1
/** VFTable/Interface Calling Convention for Win32. */
#define VFTCALL             __stdcall
/** First Entry which VAC uses. */
#define VFTFIRST_DECL       //
#define VFTFIRST_VAL()
/** This deltas which VAC uses. */
#define VFTDELTA_DECL(n)    //
#define VFTDELTA_VAL()
/** This calculates the this value to be used when calling a virtual function. */
#define VFTTHIS(pVFT, function, pvThis) ((char*)(pvThis))
/** @} */
#endif
 ...
 * nsIThreadManager
 */
typedef struct vtable_nsIThreadManager
{
    VFTnsISupports base;
