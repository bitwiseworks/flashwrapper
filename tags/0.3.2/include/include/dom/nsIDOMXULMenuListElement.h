/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM G:/Mozilla/Tree/mozilla/dom/public/idl/xul/nsIDOMXULMenuListElement.idl
 */
...
public:
  ...
  virtual ~nsDOMXULMenuListElement();
  /* additional members */
};
...
NS_IMETHODIMP nsDOMXULMenuListElement::SetLabel(const nsAString & aLabel)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
