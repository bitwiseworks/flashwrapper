#/* $Id: np2ndary.mak,v 1.3 2003/09/15 17:40:00 bird Exp $ */
...
# Target config.
#
TARGET_NAME     = np2ndary
TARGET_MODE     = LIB
TARGET_PUBLIC   = 1
MAKEFILE		= np2ndary.mak

TARGET_OBJS     = \
$(PATH_TARGET)\plugin_2nd.$(EXT_OBJ) \
#$(PATH_TARGET)\vac_dllstub.$(EXT_OBJ) \
