/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM G:/Mozilla/Tree/mozilla/dom/public/idl/xpath/nsIDOMXPathException.idl
 */
...
class NS_NO_VTABLE nsIDOMXPathException : public nsISupports {
 public: 
  ...
  enum { INVALID_EXPRESSION_ERR = 1U };
