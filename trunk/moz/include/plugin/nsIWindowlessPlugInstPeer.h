/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM G:/Mozilla/Tree/mozilla/modules/plugin/base/public/nsIWindowlessPlugInstPeer.idl
 */
...
public:
  ...
  virtual ~nsWindowlessPluginInstancePeer();
  /* additional members */
};
