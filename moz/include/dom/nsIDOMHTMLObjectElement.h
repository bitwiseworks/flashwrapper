/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM G:/Mozilla/Tree/mozilla/dom/public/idl/html/nsIDOMHTMLObjectElement.idl
 */
...
#define NS_FORWARD_SAFE_NSIDOMHTMLOBJECTELEMENT(_to) \
  ...
  NS_IMETHOD SetContentDocument(nsIDOMDocument * aContentDocument) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetContentDocument(aContentDocument); } 
...
NS_IMETHODIMP nsDOMHTMLObjectElement::SetContentDocument(nsIDOMDocument * aContentDocument)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
