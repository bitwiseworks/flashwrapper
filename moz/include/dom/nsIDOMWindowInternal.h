/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM G:/Mozilla/Tree/mozilla/dom/public/idl/base/nsIDOMWindowInternal.idl
 */
...
#define NS_NO_VTABLE
#endif
class nsISidebar; /* forward declaration */
...
#define NS_IDOMWINDOWINTERNAL_IID_STR "9c911860-7dd9-11d4-9a83-000064657374"
...
class NS_NO_VTABLE nsIDOMWindowInternal : public nsIDOMWindow {
 public: 
  ...
  NS_IMETHOD Escape(const nsAString & str, nsAString & _retval) = 0;

  /* DOMString unescape (in DOMString str); */
  NS_IMETHOD Unescape(const nsAString & str, nsAString & _retval) = 0;
...
#define NS_DECL_NSIDOMWINDOWINTERNAL \
  ...
  NS_IMETHOD Escape(const nsAString & str, nsAString & _retval); \
  NS_IMETHOD Unescape(const nsAString & str, nsAString & _retval); \
...
#define NS_FORWARD_NSIDOMWINDOWINTERNAL(_to) \
  ...
  NS_IMETHOD Escape(const nsAString & str, nsAString & _retval) { return _to Escape(str, _retval); } \
  NS_IMETHOD Unescape(const nsAString & str, nsAString & _retval) { return _to Unescape(str, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMWINDOWINTERNAL(_to) \
  ...
  NS_IMETHOD GetSidebar(nsISidebar * *aSidebar) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSidebar(aSidebar); } \
  ...
  NS_IMETHOD Escape(const nsAString & str, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Escape(str, _retval); } \
  NS_IMETHOD Unescape(const nsAString & str, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Unescape(str, _retval); } \
...
/* readonly attribute nsISidebar sidebar; */
NS_IMETHODIMP nsDOMWindowInternal::GetSidebar(nsISidebar * *aSidebar)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* DOMString escape (in DOMString str); */
NS_IMETHODIMP nsDOMWindowInternal::Escape(const nsAString & str, nsAString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* DOMString unescape (in DOMString str); */
NS_IMETHODIMP nsDOMWindowInternal::Unescape(const nsAString & str, nsAString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
