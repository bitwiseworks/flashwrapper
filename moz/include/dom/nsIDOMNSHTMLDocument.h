/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM G:/Mozilla/Tree/mozilla/dom/public/idl/html/nsIDOMNSHTMLDocument.idl
 */
...
#define NS_IDOMNSHTMLDOCUMENT_IID_STR "a6cf90c5-15b3-11d2-932e-00805f8add32"
...
class NS_NO_VTABLE nsIDOMNSHTMLDocument : public nsISupports {
 public: 
  ...
  /* nsIDOMDocument open (); */
  NS_IMETHOD Open(nsIDOMDocument **_retval) = 0;
...
#define NS_DECL_NSIDOMNSHTMLDOCUMENT \
  ...
  NS_IMETHOD Open(nsIDOMDocument **_retval); \
...
#define NS_FORWARD_NSIDOMNSHTMLDOCUMENT(_to) \
  ...
  NS_IMETHOD Open(nsIDOMDocument **_retval) { return _to Open(_retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMNSHTMLDOCUMENT(_to) \
  ...
  NS_IMETHOD Open(nsIDOMDocument **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Open(_retval); } \
...
/* readonly attribute DOMString lastModified; */
NS_IMETHODIMP nsDOMNSHTMLDocument::GetLastModified(nsAString & aLastModified)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* nsIDOMDocument open (); */
NS_IMETHODIMP nsDOMNSHTMLDocument::Open(nsIDOMDocument **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
