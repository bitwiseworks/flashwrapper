/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM G:/Mozilla/Tree/mozilla/dom/public/idl/css/nsIDOMCSS2Properties.idl
 */
...
class NS_NO_VTABLE nsIDOMCSS2Properties : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetPlayDuring(nsAString & aPlayDuring) = 0;
  NS_IMETHOD SetPlayDuring(const nsAString & aPlayDuring) = 0;
...
#define NS_DECL_NSIDOMCSS2PROPERTIES \
  ...
  NS_IMETHOD GetPlayDuring(nsAString & aPlayDuring); \
  NS_IMETHOD SetPlayDuring(const nsAString & aPlayDuring); \
...
#define NS_FORWARD_NSIDOMCSS2PROPERTIES(_to) \
  ...
  NS_IMETHOD GetPlayDuring(nsAString & aPlayDuring) { return _to GetPlayDuring(aPlayDuring); } \
  NS_IMETHOD SetPlayDuring(const nsAString & aPlayDuring) { return _to SetPlayDuring(aPlayDuring); } \
...
#define NS_FORWARD_SAFE_NSIDOMCSS2PROPERTIES(_to) \
  ...
  NS_IMETHOD GetPlayDuring(nsAString & aPlayDuring) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPlayDuring(aPlayDuring); } \
  NS_IMETHOD SetPlayDuring(const nsAString & aPlayDuring) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetPlayDuring(aPlayDuring); } \
...
/* attribute DOMString playDuring; */
NS_IMETHODIMP nsDOMCSS2Properties::GetPlayDuring(nsAString & aPlayDuring)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsDOMCSS2Properties::SetPlayDuring(const nsAString & aPlayDuring)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE nsIDOMNSCSS2Properties : public nsIDOMCSS2Properties {
 public: 
  ...
  NS_IMETHOD GetMozBoxFlexGroup(nsAString & aMozBoxFlexGroup) = 0;
  NS_IMETHOD SetMozBoxFlexGroup(const nsAString & aMozBoxFlexGroup) = 0;
  ...
  NS_IMETHOD GetMozCounterIncrement(nsAString & aMozCounterIncrement) = 0;
  NS_IMETHOD SetMozCounterIncrement(const nsAString & aMozCounterIncrement) = 0;

  /* attribute DOMString MozCounterReset; */
  NS_IMETHOD GetMozCounterReset(nsAString & aMozCounterReset) = 0;
  NS_IMETHOD SetMozCounterReset(const nsAString & aMozCounterReset) = 0;
  ...
  NS_IMETHOD GetMozKeyEquivalent(nsAString & aMozKeyEquivalent) = 0;
  NS_IMETHOD SetMozKeyEquivalent(const nsAString & aMozKeyEquivalent) = 0;
  ...
  NS_IMETHOD GetMozResizer(nsAString & aMozResizer) = 0;
  NS_IMETHOD SetMozResizer(const nsAString & aMozResizer) = 0;
...
#define NS_DECL_NSIDOMNSCSS2PROPERTIES \
  ...
  NS_IMETHOD GetMozBoxFlexGroup(nsAString & aMozBoxFlexGroup); \
  NS_IMETHOD SetMozBoxFlexGroup(const nsAString & aMozBoxFlexGroup); \
  ...
  NS_IMETHOD GetMozCounterIncrement(nsAString & aMozCounterIncrement); \
  NS_IMETHOD SetMozCounterIncrement(const nsAString & aMozCounterIncrement); \
  NS_IMETHOD GetMozCounterReset(nsAString & aMozCounterReset); \
  NS_IMETHOD SetMozCounterReset(const nsAString & aMozCounterReset); \
  ...
  NS_IMETHOD GetMozKeyEquivalent(nsAString & aMozKeyEquivalent); \
  NS_IMETHOD SetMozKeyEquivalent(const nsAString & aMozKeyEquivalent); \
  ...
  NS_IMETHOD GetMozResizer(nsAString & aMozResizer); \
  NS_IMETHOD SetMozResizer(const nsAString & aMozResizer); \
...
#define NS_FORWARD_NSIDOMNSCSS2PROPERTIES(_to) \
  ...
  NS_IMETHOD GetMozBoxFlexGroup(nsAString & aMozBoxFlexGroup) { return _to GetMozBoxFlexGroup(aMozBoxFlexGroup); } \
  NS_IMETHOD SetMozBoxFlexGroup(const nsAString & aMozBoxFlexGroup) { return _to SetMozBoxFlexGroup(aMozBoxFlexGroup); } \
  ...
  NS_IMETHOD GetMozCounterIncrement(nsAString & aMozCounterIncrement) { return _to GetMozCounterIncrement(aMozCounterIncrement); } \
  NS_IMETHOD SetMozCounterIncrement(const nsAString & aMozCounterIncrement) { return _to SetMozCounterIncrement(aMozCounterIncrement); } \
  NS_IMETHOD GetMozCounterReset(nsAString & aMozCounterReset) { return _to GetMozCounterReset(aMozCounterReset); } \
  NS_IMETHOD SetMozCounterReset(const nsAString & aMozCounterReset) { return _to SetMozCounterReset(aMozCounterReset); } \
  ...
  NS_IMETHOD GetMozKeyEquivalent(nsAString & aMozKeyEquivalent) { return _to GetMozKeyEquivalent(aMozKeyEquivalent); } \
  NS_IMETHOD SetMozKeyEquivalent(const nsAString & aMozKeyEquivalent) { return _to SetMozKeyEquivalent(aMozKeyEquivalent); } \
  ...
  NS_IMETHOD GetMozResizer(nsAString & aMozResizer) { return _to GetMozResizer(aMozResizer); } \
  NS_IMETHOD SetMozResizer(const nsAString & aMozResizer) { return _to SetMozResizer(aMozResizer); } \
...
#define NS_FORWARD_SAFE_NSIDOMNSCSS2PROPERTIES(_to) \
  ...
  NS_IMETHOD GetMozBoxFlexGroup(nsAString & aMozBoxFlexGroup) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozBoxFlexGroup(aMozBoxFlexGroup); } \
  NS_IMETHOD SetMozBoxFlexGroup(const nsAString & aMozBoxFlexGroup) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMozBoxFlexGroup(aMozBoxFlexGroup); } \
  ...
  NS_IMETHOD GetMozCounterIncrement(nsAString & aMozCounterIncrement) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozCounterIncrement(aMozCounterIncrement); } \
  NS_IMETHOD SetMozCounterIncrement(const nsAString & aMozCounterIncrement) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMozCounterIncrement(aMozCounterIncrement); } \
  NS_IMETHOD GetMozCounterReset(nsAString & aMozCounterReset) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozCounterReset(aMozCounterReset); } \
  NS_IMETHOD SetMozCounterReset(const nsAString & aMozCounterReset) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMozCounterReset(aMozCounterReset); } \
  ...
  NS_IMETHOD GetMozKeyEquivalent(nsAString & aMozKeyEquivalent) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozKeyEquivalent(aMozKeyEquivalent); } \
  NS_IMETHOD SetMozKeyEquivalent(const nsAString & aMozKeyEquivalent) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMozKeyEquivalent(aMozKeyEquivalent); } \
  ...
  NS_IMETHOD GetMozResizer(nsAString & aMozResizer) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozResizer(aMozResizer); } \
  NS_IMETHOD SetMozResizer(const nsAString & aMozResizer) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMozResizer(aMozResizer); } \
...
/* attribute DOMString MozBoxFlexGroup; */
NS_IMETHODIMP nsDOMNSCSS2Properties::GetMozBoxFlexGroup(nsAString & aMozBoxFlexGroup)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsDOMNSCSS2Properties::SetMozBoxFlexGroup(const nsAString & aMozBoxFlexGroup)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* attribute DOMString MozCounterIncrement; */
NS_IMETHODIMP nsDOMNSCSS2Properties::GetMozCounterIncrement(nsAString & aMozCounterIncrement)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsDOMNSCSS2Properties::SetMozCounterIncrement(const nsAString & aMozCounterIncrement)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* attribute DOMString MozCounterReset; */
NS_IMETHODIMP nsDOMNSCSS2Properties::GetMozCounterReset(nsAString & aMozCounterReset)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsDOMNSCSS2Properties::SetMozCounterReset(const nsAString & aMozCounterReset)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* attribute DOMString MozKeyEquivalent; */
NS_IMETHODIMP nsDOMNSCSS2Properties::GetMozKeyEquivalent(nsAString & aMozKeyEquivalent)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsDOMNSCSS2Properties::SetMozKeyEquivalent(const nsAString & aMozKeyEquivalent)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* attribute DOMString MozResizer; */
NS_IMETHODIMP nsDOMNSCSS2Properties::GetMozResizer(nsAString & aMozResizer)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsDOMNSCSS2Properties::SetMozResizer(const nsAString & aMozResizer)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
