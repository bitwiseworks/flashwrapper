/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM G:/Mozilla/Tree/mozilla/xpcom/io/nsIBinaryInputStream.idl
 */
...
class NS_NO_VTABLE nsIBinaryInputStream : public nsIInputStream {
 public: 
  ...
  NS_IMETHOD ReadBytes(char **aString, PRUint32 aLength) = 0;
...
#define NS_DECL_NSIBINARYINPUTSTREAM \
  ...
  NS_IMETHOD ReadBytes(char **aString, PRUint32 aLength); 
...
#define NS_FORWARD_NSIBINARYINPUTSTREAM(_to) \
  ...
  NS_IMETHOD ReadBytes(char **aString, PRUint32 aLength) { return _to ReadBytes(aString, aLength); } 
...
#define NS_FORWARD_SAFE_NSIBINARYINPUTSTREAM(_to) \
  ...
  NS_IMETHOD ReadBytes(char **aString, PRUint32 aLength) { return !_to ? NS_ERROR_NULL_POINTER : _to->ReadBytes(aString, aLength); } 
...
/* void readBytes ([size_is (aLength)] out string aString, in PRUint32 aLength); */
NS_IMETHODIMP nsBinaryInputStream::ReadBytes(char **aString, PRUint32 aLength)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
