/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM E:/mozilla/tree/mozilla/modules/oji/public/nsIJVMPluginInstance.idl
 */
...
class NS_NO_VTABLE nsIJVMPluginInstance : public nsISupports {
 public: 
