/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM G:/Mozilla/Tree/mozilla/dom/public/idl/xul/nsIDOMXULSelectCntrlItemEl.idl
 */
...
public:
  ...
  virtual ~nsDOMXULSelectControlItemElement();
  /* additional members */
};
