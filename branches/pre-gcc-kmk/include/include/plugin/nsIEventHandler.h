/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM G:/Mozilla/Tree/mozilla/modules/plugin/base/public/nsIEventHandler.idl
 */
...
class NS_NO_VTABLE nsIEventHandler : public nsISupports {
 public:
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IEVENTHANDLER_IID)
