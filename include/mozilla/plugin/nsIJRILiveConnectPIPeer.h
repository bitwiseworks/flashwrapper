/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM G:/Mozilla/Tree/mozilla/modules/plugin/base/public/nsIJRILiveConnectPIPeer.idl
 */
...
public:
  ...
  virtual ~nsJRILiveConnectPluginInstancePeer();
  /* additional members */
};
